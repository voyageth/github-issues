...
function getInstallerConfig () {
  ...
  return Promise.resolve({
    appDirectory: path.join(outPath, 'github-issues-win32-ia32'),
    // TODO Switch iconUrl to https://raw.githubusercontent.com/voyageth/github-issues/master/assets/app-icon/win/app.ico
    ...
    setupExe: 'github-issuesSetup.exe',
